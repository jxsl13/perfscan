...
// PS5035 is an AutoFix check: the fixes are applied and diffed against a
...
// identifiers. See equiv_PS5035_test.go for the runtime proof that
// TrimSpace and TrimFunc(s, unicode.IsSpace) return byte-identical
// results on every input.
func TestPS5035(t *testing.T) {
	analysistest.RunWithSuggestedFixes(t, analysistest.TestData(), PS5035.Analyzer, "ps5035")
}
