...
func TestPS3006(t *testing.T) {
	analysistest.RunWithSuggestedFixes(t, analysistest.TestData(), PS3006.Analyzer, "ps3006")
}

func TestPS3006Cgo(t *testing.T) {
	...
	analysistest.RunWithSuggestedFixes(t, analysistest.TestData(), PS3006.Analyzer, "ps3006cgo")
}
