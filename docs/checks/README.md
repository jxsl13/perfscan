...
**424 checks total** — **265 with a bit-identical auto-fix**, 159 advisory. By fix level: **246 L1** (idiomatic), **124 L2** (structured), **54 L3** (aggressive).
...
| [PS2145](PS2145.md) | alloc | L3 |  | a file-path wrapper heap-copies reader-derived payload retained by returned views |
...
| [PS6085](PS6085.md) | verify | L3 |  | a hot loop repeatedly adjusts a bounded immutable lookup row for a small state |
...
| [PS6121](PS6121.md) | verify | L3 |  | a source-monomorphic function value is invoked inside a parallel element loop |
...
| [PS6131](PS6131.md) | verify | L3 |  | a measured serial/parallel dispatch crossover has stale source or toolchain evidence |
