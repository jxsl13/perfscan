...
func sortedCommented(ys []string) []string {
	return slices.SortedFunc(slices.Values(ys), /* keep me */ strings.Compare) // want `slices\.Sorted collects and sorts the string elements in the identical byte-lexicographic order`
}
