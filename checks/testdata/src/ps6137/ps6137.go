...
/*
#include <stdint.h>
// Frozen verbatim GoAI 9501df31a4b9db0852875322afecd5b352c64f0d backend/metal/metal_bridge.h snapshot declarations.
...
// Frozen verbatim declarations/functions from GoAI parent9501df31a4b9db0852875322afecd5b352c64f0d backend/metal/metal.go.
...
func (r *Recorder) Profile() (RecorderProfile, error) {
	...
	rc := C.mtl_recorder_profile_snapshot(r.handle, &events, &count, &omittedMPS,
		&omittedOverflow, &omittedUnsupported, &frequency, &commandDurationNS) // want `review an additive caller-owned Into`
	if rc != 0 {
