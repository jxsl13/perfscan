...
func (d *Decoder) allocScratch(mk func(data []float32) *bufSlot) {
	...
	d.ao = mk(make([]float32, c*d.d)) // want "candidate unused constructor scratch .*Decoder[.]ao:"
	...
	d.mo = mk(make([]float32, c*d.d)) // want "candidate unused constructor scratch .*Decoder[.]mo:"
	d.logitsRows = 1
